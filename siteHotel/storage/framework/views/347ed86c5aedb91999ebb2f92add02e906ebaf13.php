        ...
        <div class="relative flex items-top  min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 left-0 sm:block">
                    ...
                    <a href="#about" class="w3-bar-item w3-button w3-mobile">Réserver</a>
...
<?php /**PATH /home/sebastien/projetfinAnnee/hotel/siteHotel/resources/views/LayoutPublic/welcome.blade.php ENDPATH**/ ?>